...
const[DAI,BAT,REP,ZRX] = ['DAI','BAT','REP','ZRX']
 ...
 module.exports = async function(deployer, _network, accounts){ //deploy all ERC20 tokens with DEX
    const[trader1, trader2, trader3, trader4, _]  = accounts; //simulate 3 traders
    await Promise.all(
    ...
    //call addtoken function from DEX
    await Promise.all([
    ...
    //utility function to increase time
    const increaseTime = async (seconds) => {
     ...
     await increaseTime(1); //increase time by 1 sec artificially 
